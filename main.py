...
def run_ai_agent(reporte_final):

    try:

        print("🤖 BACKGROUND TASK — Running AI Agent")
...
async def audit_process(
    ...
    async with pipeline_semaphore:
        ...
        try:
            ...
            # 8️⃣ AI AGENT
            # =========================
            print("🤖 STEP 8 — Scheduling AI agent")
            ...
            print("✅ AI agent scheduled in background")
